...
use wiz_mir::expr::{MLCall, MLCallArg, MLExpr, MLLiteral, MLMember, MLName, MLUnaryOp, MLUnaryOpKind};
        ...
        body: vec![
            MLDecl::Fun(MLFun {
                ...
                arg_defs: vec![
                    MLArgDef {
                        name: "p".to_string(),
                        type_: MLValueType::Reference(Box::new(MLType::Value(MLValueType::Primitive(MLPrimitiveType::Int64))))
                    }
                ],
                return_type: MLValueType::Primitive(MLPrimitiveType::Int64),
                body: None
            ...
            MLDecl::Fun(MLFun {
                ...
                body: Some(MLFunBody {
                    body: vec![
                        MLStmt::Expr(MLExpr::Return(MLReturn { value: Some(Box::new(MLExpr::PrimitiveUnaryOp(MLUnaryOp {
                            target: Box::new(MLExpr::Name(MLName {
                                name: "p".to_string(),
                                type_: MLType::Value(MLValueType::Reference(Box::new(MLType::Value(MLValueType::Primitive(MLPrimitiveType::Int64)))))
                            })),
                ...
                body: Some(MLFunBody {
                    body: vec![
                        MLStmt::Var(MLVar {
                            ...
                            value: MLExpr::Literal(MLLiteral::Integer { value: "1".to_string(), type_: MLValueType::Primitive(MLPrimitiveType::Int64) })
                        }),
                        MLStmt::Expr(MLExpr::Call(MLCall {
                            target: MLName { name: "test::reference_dereference##_#&Int64".to_string(), type_: MLType::Function(MLFunctionType {
                                arguments: vec![
                                    MLValueType::Reference(Box::new(MLType::Value(MLValueType::Primitive(MLPrimitiveType::Int64))))
                                ],
                                return_type: MLValueType::Primitive(MLPrimitiveType::Int64)
                            }) },
                            args: vec![
