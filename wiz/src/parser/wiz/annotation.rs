use nom::{IResult, Slice, InputIter, InputLength, InputTake, FindSubstring, Compare, AsChar};
use crate::syntax::annotation::{AnnotationsSyntax, Annotation};
...
mod tests {
    ...
    #[test]
    fn test_annotations() {
        assert_eq!(annotations("#[no_mangle]"), Ok(("", AnnotationsSyntax {
            open: TokenSyntax::new("#[".to_string()),
            annotations: vec![Annotation { name: TokenSyntax::new("no_mangle".to_string()), trailing_comma: TokenSyntax::new("".to_string()) }],
